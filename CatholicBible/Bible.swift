...
struct BibleBook: Identifiable, Hashable, Sendable {
    ...
    var searchKeywords: [String] {
        ...
        let commonBaseNames: [String: String] = [
            ...
            "1티모": "티모",
            "2티모": "티모",
            // "1베드", "2베드" 제거 - "베드로"는 요청 시 명시적으로 "1베드" 또는 "2베드" 입력
            // "1요한", "2요한", "3요한" 제거 - "요한"은 요한 복음서만 지원
            "1사무": "사무",
            "2사무": "사무",
            "1열왕": "열왕",
            "2열왕": "열왕",
        ...
        let romanizationVariants: [String: [String]] = [
            ...
            // ───── 신약 · 복음서 ─────
            "마태": ["마태오", "마태오복음", "마태복음"],
            "마르": ["마르코", "마가", "마르코복음", "마가복음"],
            "루카": ["루가", "누가", "루카복음", "루가복음", "누가복음"],
            "요한": ["요한복음", "요한의복음"],
            ...
            // 코린토/고린도
            "코린토": ["고린도", "고린도인", "코린도"],
            "1코린": ["1고린", "1고린도", "1고린도인", "1코린도", "고린도전서"],
            "2코린": ["2고린", "2고린도", "2고린도인", "2코린도", "고린도후서"],

            // 갈라디아
            "갈라": ["갈라디아", "갈라디아인"],

            // 에페소/에베소
            "에페": ["에베소", "에베소인", "에페소", "에페소인"],

            // 필리피/필립비
            "필리": ["필립", "빌립보", "빌립보인", "필립보인", "필립비", "필립비인"],

            // 콜로새/골로사이
            "콜로": ["골로", "골로새", "골로새인"],

            // 테살로니카/데살로니카
            "테살": ["데살", "데살로니가", "데살로니가인", "테살로니카", "데살로니카", "데살로니카인"],
            "1테살": ["1데살", "1데살로니가", "1테살로니카", "1데살로니카", "데살로니카전서"],
            "2테살": ["2데살", "2데살로니가", "2테살로니카", "2데살로니카", "데살로니카후서"],

            // 티모테오/디모테오
            "티모": ["디모", "디모테오", "디모데"],
            "1티모": ["1디모", "1디모테오", "1디모데", "디모데전서"],
            "2티모": ["2디모", "2디모테오", "2디모데", "디모데후서"],
            ...
            // ───── 신약 · 가톨릭 서간 ─────
            "야고": ["야고보", "야고보서", "야고보의 편지"],
            "1베드": ["베드로", "베드로전서", "베드로의 첫째 편지"],
            "2베드": ["베드로", "베드로후서", "베드로의 둘째 편지"],
            "1요한": ["요한", "요한일서", "요한의 첫째 편지"],
            "2요한": ["요한", "요한이서", "요한의 둘째 편지"],
            "3요한": ["요한", "요한삼서", "요한의 셋째 편지"],
            "유다": ["유다서", "유다의 편지"],

            // ───── 신약 · 묵시록 ─────
            "묵시": ["계시록", "요한계시록", "요한의 묵시록"],
        ]
...
enum Bible {
    static let books: [BibleBook] = [
        ...
        BibleBook(id: "mi",    name: "미카서",     shortName: "미카",     abbrev: "미카",  category: .prophets, chapterCount: 7),
        ...
        BibleBook(id: "hg",    name: "하까이서",   shortName: "하까",   abbrev: "하까",  category: .prophets, chapterCount: 2),
        BibleBook(id: "zec",   name: "즈카르야서", shortName: "즈카", abbrev: "즈카",  category: .prophets, chapterCount: 14),
        ...
        BibleBook(id: "lk",    name: "루카 복음서",   shortName: "루카",   abbrev: "루카", category: .gospels, chapterCount: 24),
        ...
        BibleBook(id: "1cor",  name: "코린토 신자들에게 보낸 첫째 서간",   shortName: "1코린",   abbrev: "1코린",  category: .paulineLetters, chapterCount: 16),
        BibleBook(id: "2cor",  name: "코린토 신자들에게 보낸 둘째 서간",   shortName: "2코린",   abbrev: "2코린",  category: .paulineLetters, chapterCount: 13),
        ...
        BibleBook(id: "phil",  name: "필리피 신자들에게 보낸 서간",        shortName: "필리",     abbrev: "필리",   category: .paulineLetters, chapterCount: 4),
        BibleBook(id: "col",   name: "콜로새 신자들에게 보낸 서간",        shortName: "콜로",     abbrev: "콜로",   category: .paulineLetters, chapterCount: 4),
        BibleBook(id: "1thes", name: "테살로니카 신자들에게 보낸 첫째 서간", shortName: "1테살", abbrev: "1테살", category: .paulineLetters, chapterCount: 5),
        BibleBook(id: "2thes", name: "테살로니카 신자들에게 보낸 둘째 서간", shortName: "2테살", abbrev: "2테살", category: .paulineLetters, chapterCount: 3),
        BibleBook(id: "1tm",   name: "티모테오에게 보낸 첫째 서간",        shortName: "1티모", abbrev: "1티모",  category: .paulineLetters, chapterCount: 6),
        BibleBook(id: "2tm",   name: "티모테오에게 보낸 둘째 서간",        shortName: "2티모", abbrev: "2티모",  category: .paulineLetters, chapterCount: 4),
        BibleBook(id: "ti",    name: "티토에게 보낸 서간",                 shortName: "티토",       abbrev: "티토",   category: .paulineLetters, chapterCount: 3),
